...
$result_count = mysqli_query(
    $conn,
    "SELECT COUNT(*) As total_records FROM `festekek`"
);
...
switch ($_GET['sorter']) {
    ...
    case "price":
        ...
        break;
    case "merete":
        $OrderBy = "ORDER BY merete ";
        break;
    case "faj":
        $OrderBy = "ORDER BY fajtaja ";
        break;
}
$result = mysqli_query(
    $conn,
    "SELECT * FROM `festekek` $OrderBy LIMIT $offset, $total_records_per_page"
);
...
<head>
    ...
    <meta name="title" content="Festekek">
        ...
        <main id="maincontent" class="page-main">
            <div class="page-title-wrapper category-description">
                <h1 class="page-title" id="page-title-heading " aria-labelledby="page-title-heading toolbar-amount">
                    <span class="base" data-ui-id="page-title-wrapper">Festékek</span>
                </h1>
                <h5>
                    Fesd ki katonáidat, hogy az ellenségeid már távolról is felismerjék a végzetüket!
                </h5>
            </div>
            <div class="columns">
                <div class="column main">
                    <div class="products wrapper grid products-grid">
                        <?php include "toolbar/festekek_toolbar.php"; ?>
                                                    ...
                                                    <strong class="product name product-item-name">
                                                        <h4 id="termekNeve">
                                                            <a class="product-item-link"
                                                                href="vasarlo_felulet_festekek.php?id=<?= $row["id"] ?>">
                                                                <?= $row["neve"] ?>
                                                            </a>
                                                        </h4>
                                                    </strong>
